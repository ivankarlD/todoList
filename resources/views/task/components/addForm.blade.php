<div class="modal-body">
    <form id="addTaskForm" action="{{Route('task.store')}}" class="row" method="POST">
        ...
        <div class="col-md-6">
            ...
            <select class="form-select" id="categories_add" name="category_id" aria-label="Default select example">
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="addTaskSubmitBtn" onclick="$('#addTaskForm').submit()">Save</button>
    </form>
</div>